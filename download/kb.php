...
* @version $Id: kb.php 342 2009-10-28 14:05:22Z tom.martin60@btinternet.com $
...
{
	wrap_img_in_html(append_sid($phpbb_root_path . 'download/kb.' . $phpEx, 'id=' . $attachment['attach_id']), $attachment['real_filename']);
}
else
{
